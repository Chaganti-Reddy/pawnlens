...
import { FaLightbulb, FaChalkboardUser } from '../ui/icons.js';

// The coach's take on the current move, shown as a coach avatar + speech bubble,
// with the engine's best line to follow.
export default function CoachCard({ node }) {
  const { t } = useTranslation();
  if (!node) return null;
  return (
    <div className="coach-wrap">
      <div className="coach-avatar" style={{ background: node.tagColor }}>
        <FaChalkboardUser />
      </div>
